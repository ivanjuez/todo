...
#Defino los diferentes grupos de MOVEGROUP como son el brazo por un lado y la pinza
    ...
    GRIPPER_FRAME = 'panda_hand' #mi duda es si aqui debo poner donde se fija el dedo "gripper_finger1_joint" o directamente sería el mismo
...
if __name__=='__main__':
	...
	grasp_pose.pose.position.z = grasp_pose.pose.position.z + 0.1
	...
	move_pose_arm(pi/2,0,pi,0.5,-0.3,0.2)
        rospy.sleep(4)
